...
import { DeleteE, Memp, RenderL,ModE, renderBit, reporte, renderBitF, RenderC, cambiarC, Renderde, deprecalculo, reporteMant, Renderbackup, RealizarB, restore, revalor } from "../controllers/index.CO.js";
...
Adm.post('/Restore',logeado,restore)
